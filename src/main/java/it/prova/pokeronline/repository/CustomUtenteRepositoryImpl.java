...
public class CustomUtenteRepositoryImpl  implements CustomUtenteRepository{
	...
	public List<Utente> findByExample(Utente example) {
		...
		if (example.getDateRegistrazione() != null) {
			whereClauses.add("u.dateRegistrazione >= :dateRegistrazione ");
			paramaterMap.put("dateRegistrazione", example.getDateRegistrazione());
		}
